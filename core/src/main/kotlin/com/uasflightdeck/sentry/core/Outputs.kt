...
enum class SoundLevel(
    ...
    WARNING("warning", "Warning", true, listOf("Oxygen.ogg", "Alarm_Beep_03.ogg"), longArrayOf(0, 300, 150, 300, 150, 300)),
    COLLISION("collision", "Collision risk", true, listOf("Alarm_Buzzer.ogg", "Alarm_Beep_02.ogg"), longArrayOf(0, 500, 200, 500, 200, 500)),
